...
REPO_URL=${1:-"https://github.com/xvnds/MongooseIM.git"}
...
docker run --rm -v mongooseim-builds:/builds -e TARBALL_NAME=mongooseim mongooseim-builder /build.sh MongooseIM ${REPO_URL} ${COMMIT_HASH} 
